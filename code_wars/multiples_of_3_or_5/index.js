...
// function createArrayWithoutDuplicateNumbers(arrayA, arrayB) {

// const array3 = []
// for (let i=0; i< arrayA.length; i++) { for (let j=0; j<arrayB.length; j++){if (arrayA[i] == to arrayB[j]); {array3.push(arrayA[i])}}}}
